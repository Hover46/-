...
public class EnterPanel extends JPanel implements PageSwitchSubject {
	private Board board;
	...
	private void initializeBoard() {
		...
		startButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// 更新UserData
				UserData.setUniqueInstance((UserData) SaveManager.loadData("UserData"));
				// 切换到游戏界面
				listener.switchToPage("SelectLoginMethodMenu");
			}
		});

		// 创建设置按钮
		JButton settingsButton = createStyledButton("游戏设置");
		settingsButton.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(EnterPanel.this, "这里可以添加设置功能");
			}
		});
		...
		exitButton.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				int result = JOptionPane.showConfirmDialog(EnterPanel.this, "确定要退出游戏吗？", "退出确认",
